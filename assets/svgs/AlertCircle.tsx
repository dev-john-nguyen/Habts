...
const alert = `<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
...
export default ({ strokeColor, fillColor }: Props) => (
    <SvgXml xml={alert} width='100%' height='100%' stroke={strokeColor} fill={fillColor} />
)